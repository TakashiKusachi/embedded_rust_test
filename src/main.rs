...
const IP_LOCAL: [u8; 4] = [192, 168, 10, 110];
const IP_REMOTE: [u8; 4] = [192, 168, 10, 101];
...
///
/// set_clock_source
fn set_clock_source(pwr: hal::pwr::Pwr, rcc: hal::rcc::Rcc, syscfg: &hal::device::SYSCFG) -> hal::rcc::Ccdr {
...
fn main() -> ! {
    ...
    let ccdr = set_clock_source(pwr, rcc, &dp.SYSCFG);
